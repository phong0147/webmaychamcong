        ...
        <form action="{{route('login')}}" method="POST">
         @csrf   
          <div class="divider d-flex align-items-center my-4">
            <p class="text-center fw-bold mx-3 mb-0">Hệ Thống Chấm Công Tính Lương</p>
          </div>
          <!-- Email input -->
          @if(session('status'))
          ...
          <div class="form-outline mb-4">
            <input name="user_name" type="text" id="form3Example3" class="form-control form-control-lg"
